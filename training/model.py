...
def VGG16_Char(classes=62):
    ...
    model.add(Activation('relu'))
    model.add(Dropout(rate=0.5))
    model.add(Dense(units=classes, name='classifier'))
    model.add(BatchNormalization())
...
def squeeze_net(classes=62, inputs=(224, 224, 1)):
    ...
    merge1 = Concatenate(axis=3, [fire1_e1, fire1_e3])
    ...
    merge2 = Concatenate(axis=3, [fire2_e1, fire2_e3])
    ...
    merge3 = Concatenate(axis=3,[fire3_e1, fire3_e3])
    ...
    merge4 = Concatenate(axis=3,[fire4_e1, fire4_e3])
    ...
    merge5 = Concatenate(axis=3,[fire5_e1, fire5_e3])
    ...
    merge6 = Concatenate(axis=3,[fire6_e1, fire6_e3])
    ...
    merge7 = Concatenate(axis=3,[fire7_e1, fire7_e3])
    ...
    merge8 = Concatenate(axis=3,[fire8_e1, fire8_e3])
    ...
    merge9 = Concatenate(axis=3,[fire9_e1, fire9_e3])
